...
{
$res = $q->fetch_assoc();
$_SESSION['aemail']=$res['email'];
$_SESSION['aid']=$res['id'];
$_SESSION['afname']=$res['fname'];
$_SESSION['amobNo']=$res['mobNo'];
$_SESSION['aaddress']=$res['address'];
$_SESSION['aprofile']=$res['profile'];
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h1 style="color:white; text-shadow: 2px 2px 5px black;">ECARS Admin Login</h1>
                    </a>
                </div>
